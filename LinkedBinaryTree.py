...
class LinkedBinaryTree:
    ...
    def leaves_list(self):
        def leaves_list_subtree(root):
            if root is None:
                pass
            elif root.left is None and root.right is None:
                yield root.data
            elif root.left is not None and root.right is None:
                yield from leaves_list_subtree(root.left)
            elif root.left is None and root.right is not None:
                yield from leaves_list_subtree(root.right)
            else:
                yield from leaves_list_subtree(root.left)
                yield from leaves_list_subtree(root.right)

        return list(leaves_list_subtree(self.root))
        ...
        if curr is None:
            ...
            while curr is not None:
                if curr.left is None:
                    ...
                    while (previous.right is not None and previous.right != curr):
